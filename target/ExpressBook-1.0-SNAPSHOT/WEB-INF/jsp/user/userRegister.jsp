...
<!--                            <li class="dropdown"><a href="index.html">Home</a></li>
                            ...
                            <li class="dropdown"><a href="/ExpressBook/admin/adminPage">Admin</a></li>
                        </ul>
            ...
            <div class="container">
                ...
                <div class="sign-up-form">
                    ...
                    <div class="form-wrapper">
                        <p class="signup-text">Sign up now and meet awesome people around the world</p>
                        <form action="/ExpressBook/user/userRegister" method="post">
                            ...
                            <fieldset class="form-group">
                                <label for="mob_email">Mobile Or Email : </label>
                                <input type="text" class="form-control" id="mob_email" placeholder="Enter Mobile No Or Email" name="mob_email">
                            </fieldset>
                            <fieldset class="form-group">
                            ...
                            <fieldset class="form-group">
                                ...
                                <!-- checked="checked <input type="text" class="form-control" id="gender" placeholder="Enter your Gender" name="gender">-->
                                <label  class="radio-inline">
                                    <input type="radio" name="gender" id="male"  value="male""/>Male
                                </label>
                                <label  class="radio-inline">
                                    <input  type="radio" name="gender"  id="staff" value="female"/>Female
                                </label>
                            </fieldset>
                            <p>By signning up you agree to the terms</p>
                            <button type="submit" class="btn-secondary">Signup</button><p></p>
                            <button type="reset" class="btn-secondary">Reset</button>                            
                        </form>                
                    </div>
                    <a href="/ExpressBook/user/userLogin">Already have an account?</a>
