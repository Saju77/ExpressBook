...
<!--                                    <img src="<c:url value='/resources/images/users/user-1.jpg'/>" alt="" class="img-responsive profile-photo" />-->
                                    <img src="/ExpressBook/timeline/imageDisplay?id=${map.about.user.user_id}" alt="about-image" class="img-responsive profile-photo"/>
                                    <h5><a href="timeline.html" class="text-black"><c:out value="${map.about.user.full_name}"/></a></h5>
                                    <!--<h5><a href="timeline.html" class="text-black">${LoggedUsername}</a></h5>-->
                            ...
                            <div class="col-md-9"> 
                                <ul class="list-inline profile-menu">
                                    <!--<li><a href="/ExpressBook/timeline/timelinePage">Timeline</a></li>-->
                                    <li><a href="/ExpressBook/timeline/friendsAbout/${map.about.user.user_id}" class="active">About</a></li>
                                    <!--                                    <li><a href="/ExpressBook/timeline/albumPage">Album</a></li>
                                                                        <li><a href="timeline-friends.html">Friends</a></li>-->
                                </ul>
                                <ul class="follow-me list-inline">
                                    <!--                                    <li>1,299 people following her</li>-->
                                    <li><a href="/ExpressBook/timeline/fReqSave/${map.about.user.user_id}"><button class="btn-primary">Add Friend</button></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="navbar-mobile hidden-lg hidden-md">
                        ...
                        <div class="mobile-menu">
                            ...
                            <a href="/ExpressBook/timeline/fReqSave/${map.about.user.user_id}"><button class="btn-primary">Add Friend</button></a>
                        </div>
