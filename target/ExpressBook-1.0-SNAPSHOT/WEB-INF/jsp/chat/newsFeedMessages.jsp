<%-- 
    Document   : newsFeedMessages
    Created on : Aug 30, 2020, 8:30:26 PM
    Author     : USER
--%>
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<c:url value='/resources/css/jquery.scrollbar.css'/>" />
      ...
      ================================================= -->
                    <div class="col-md-3 static">
                        <div class="profile-card">
                            <img src="<c:url value='/resources/images/users/user-1.jpg'/>" alt="user" class="profile-photo" />
                            <!--<h5><a href="timeline.html" class="text-white">Sarah Cruiz</a></h5>-->
                            <h5><a href="timeline.html" class="text-white"><c:out value="${LoggedUsername}"/></a></h5>
                        ...
                        <div class="create-post">
                            <div class="row">
                                <div class="col-md-7 col-sm-7">
                                    <div class="form-group">
                                        <img src="<c:url value='/resources/images/users/user-1.jpg'/>" alt="" class="profile-photo-md" />
                                    ...
                                    <ul class="nav nav-tabs contact-list scrollbar-wrapper scrollbar-outer">
                                        ...
                                        <c:forEach items="${map.userList}" var="user">
                                            ...
                                            <a href="#contact-1" data-toggle="tab">
                                                <div class="contact">
                                                    <img src="<c:url value='/resources/images/users/user-2.jpg'/>" alt="" class="profile-photo-sm pull-left"/>
                                        ...
                                        <li>
                                            <a href="#contact-2" data-toggle="tab">
                                                <div class="contact">
                                                    <img src="<c:url value='/resources/images/users/user-10.jpg'/>" alt="" class="profile-photo-sm pull-left"/>
                                                    <div class="msg-preview">
                                                        <h6>Julia Cox</h6>
                                        ...
                                        <li>
                                            <a href="#contact-3" data-toggle="tab">
                                                <div class="contact">
                                                    <img src="<c:url value='/resources/images/users/user-3.jpg'/>" alt="" class="profile-photo-sm pull-left"/>
                                                    <div class="msg-preview">
                                                        <h6>Sophia Lee</h6>
                                        ...
                                        <li>
                                            <a href="#contact-4" data-toggle="tab">
                                                <div class="contact">
                                                    <img src="<c:url value='/resources/images/users/user-4.jpg'/>" alt="" class="profile-photo-sm pull-left"/>
                                                    <div class="msg-preview">
                                                        <h6>John Doe</h6>
                                        ...
                                        <li>
                                            <a href="#contact-5" data-toggle="tab">
                                                <div class="contact">
                                                    <img src="<c:url value='/resources/images/users/user-9.jpg'/>" alt="" class="profile-photo-sm pull-left"/>
                                                    <div class="msg-preview">
                                                        <h6>Anna Young</h6>
                                        ...
                                        <li>
                                            <a href="#contact-6" data-toggle="tab">
                                                <div class="contact">
                                                    <img src="<c:url value='/resources/images/users/user-8.jpg'/>" alt="" class="profile-photo-sm pull-left"/>
                                                    <div class="msg-preview">
                                                        <h6>Richard Bell</h6>
                                        ...
                                        <div class="tab-pane active" id="contact-1">
                                            <div class="chat-body">
                                                <ul class="chat-message">
                                                    ...
                                                    <li class="right">
                                                        <img src="<c:url value='/resources/images/users/user-1.jpg'/>" alt="" class="profile-photo-sm pull-right" />
                                                        <div class="chat-item">
                                                            <div class="chat-item-header">
                                                                <h5>Sarah Cruiz</h5>
                                                                <small class="text-muted">3 days ago</small>
      ...
      ================================================= -->
                    <div class="col-md-2 static">
                        <div class="suggestions" id="sticky-sidebar">
                            ...
                            <div class="follow-user">
                                <img src="<c:url value='/resources/images/users/user-13.jpg'/>" alt="" class="profile-photo-sm pull-left" />
                                <div>
