<%-- 
    Document   : timelineAlbum
    Created on : Aug 28, 2020, 12:42:20 PM
    Author     : USER
--%>
                                    ...
                                    <c:if test="${post.user.user_id == LoggedUserId}">
                                        ...
                                        <li>
                                            <div class="img-wrapper" data-toggle="modal" data-target=".photo-1">
                                                <img src="/ExpressBook/post/imageDisplay?id=${post.post_id}" alt="photo"/>
                                              <!--<img src="<c:url value='/resources/images/album/1.jpg'/>" alt="photo" />-->
                                            </div>
